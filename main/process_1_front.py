...
if __name__ == '__main__':
    ...
    multi_process_check_photo(
        save_path='/home/data/temp/zhouzx/ocr_analysis/main/data_sets/di_store/di_store_unclassified_data_1.csv')
